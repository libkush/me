...
<div class="flex flex-col h-screen flex-grow w-full sm:m-auto gap-8">
  <section class="w-full h-full">
    <div class="posts pt-6 overflow-x-hidden max-h-full flex flex-col">
      {#each posts as post}
        <article
          class="md:border-l pb-8 pt-8 md:border-zinc-100 md:pl-6 md:dark:border-zinc-100/40 w-3/5 m-auto grid items-start grid-cols-4 gap-8"
        >
